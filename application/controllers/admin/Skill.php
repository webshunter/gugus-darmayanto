...
class Skill extends CI_Controller {
	...
	public function index()
	{
        ...
        $this->Createtable->create_row(["No","Foto","Skill","Deskripsi","Tanggal Dibuat","Tanggal Diupdate", "action"]);
            ...
            $this->Datatable_gugus->datatable(
                [
                    ...
                    'search' => [
                        ...
                        'row' => ["foto","skill","deskripsi","created_at","updated_at"]
                    ],
                    'table-draw' => post('draw'),
                    'table-show' => [
                        'key' => 'id',
                        'data' => ["foto","skill","deskripsi","created_at","updated_at"]
                    ],
                    "action" => "standart",
                    'order' => [
                        'order-default' => ['id', 'ASC'],
                        'order-data' => $setorder,
                        'order-option' => [ "1"=>"foto", "2"=>"skill", "3"=>"deskripsi", "4"=>"created_at", "5"=>"updated_at", "6"=>"delete_set"],
                    ],
...
$deskripsi = post("deskripsi");
        ...
        $simpan = $this->db->query("
            INSERT INTO skill
            (foto,skill,deskripsi) VALUES ('$foto','$skill',\"$deskripsi\")
        ");
...
$deskripsi = post("deskripsi");
        ...
        $simpan = $this->db->query("
            UPDATE skill SET  foto = '$foto', skill = '$skill', deskripsi = \"$deskripsi\" WHERE id = '$key'
            ");
