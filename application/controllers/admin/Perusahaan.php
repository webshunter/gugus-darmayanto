...
class Perusahaan extends CI_Controller {
	...
	public function index()
	{
        ...
        $this->Createtable->create_row(["no","nama","alamat","email","telephone","handphone","instagram","facebook","twitter","tanggal daftar","tanggal update", "action"]);
            ...
            $this->Datatable_gugus->datatable(
                [
                    ...
                    'search' => [
                        ...
                        'row' => ["nama","alamat","email","tlpn","hp","ig","fb","tw","created_at","updated_at"]
                    ],
                    'table-draw' => post('draw'),
                    'table-show' => [
                        'key' => 'id',
                        'data' => ["nama","alamat","email","tlpn","hp","ig","fb","tw","created_at","updated_at"]
                    ],
                    "action" => "standart",
                    'order' => [
                        'order-default' => ['id', 'ASC'],
                        'order-data' => $setorder,
                        'order-option' => [ "1"=>"nama", "2"=>"alamat", "3"=>"email", "4"=>"tlpn", "5"=>"hp", "6"=>"ig", "7"=>"fb", "8"=>"tw", "9"=>"created_at", "10"=>"updated_at", "11"=>"delete_set"],
                    ],
