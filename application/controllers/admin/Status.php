            ...
            $this->Datatable_gugus->datatable(
                [
                    ...
                    'search' => [
                        ...
                        'row' => ["status","created_at","updated_at", "id"]
                    ],
                    'table-draw' => post('draw'),
                    'table-show' => [
                        'key' => 'id',
                        'data' => ["status","created_at","updated_at", "id"]
                    ],
                    "action" => "standart",
                    'order' => [
                        'order-default' => ['id', 'ASC'],
                        'order-data' => $setorder,
                        'order-option' => [ "1"=>"status", "2"=>"created_at", "3"=>"updated_at", "4"=>"delete_set"],
                    ],
                    "custome" => [
                        "id" => [
                            "key" => ["id"],
                            "content" => "<button data-id=\"{{id}}\" class=\"btn btn-success edit\"> <i class=\"fas fa-edit\"></i> edit</button>"
                        ]
                    ]
                ]
            );
